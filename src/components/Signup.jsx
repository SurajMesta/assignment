        ...
        return(
          <div className='text-center' style={{width:'400px',margin:'auto'}}>
              <form>
                  ...
                  <div className="form-group">
                        <Link onClick={e => (!this.state.name || !this.state.password || !this.state.email || !this.state.number) ? e.preventDefault():null} to={`/login?name=${this.state.name}&password=${this.state.password}&email=${this.state.email}&number=${this.state.number}`}>
